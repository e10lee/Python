...
# Return value: none
def printPrettyBoard(board_list): #prints a prettier board
    print()
    counter = 0
    for i in range(3):
        for j in range(3):
            if counter == 0: #if the counter is 0
                print(board_list[counter], end = " | ") #print number and slash
                counter += 1
            elif counter == 1: #if the counter is 1
                print(board_list[counter], end=" | ") #print number and slash
                counter += 1
            elif counter == 2: #if the counter is 2
                print(board_list[counter])
                print("---------", end="") #print number and dashes
                counter += 1
            elif counter == 3: #if the counter is 3
                print(board_list[counter], end=" | ") #print number and slash
                counter += 1
            elif counter == 4: #if the counter is 4
                print(board_list[counter], end=" | ") #print number and slash
                counter += 1
            elif counter == 5: #if the counter is 5
                print(board_list[counter])
                print("---------", end="") #print number and dashes
                counter += 1
            elif counter == 6: #if the counter is 6
                print(board_list[counter], end=" | ") #print number and slash
                counter += 1
            elif counter == 7: #if the counter is 7
                print(board_list[counter], end=" | ") #print number and slash
                counter += 1
            else:
                print(board_list[counter])
